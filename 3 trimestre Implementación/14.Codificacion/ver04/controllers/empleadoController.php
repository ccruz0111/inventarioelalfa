...
public function state_persona(){
    $persona = parent::find_persona($_GET['id_persona']);
    
    if($persona->estado==1){
        echo parent::inac_state_persona($_GET['id_persona']) ? '<script type="text/javascript">
        alert("¡Cambiando estado ...!");window.location.href="?controller=empleado&method=clientes";
        </script>' : '<script type="text/javascript">
        alert("¡Cliente actualizado con éxito!");window.location.href="?controller=empleado&method=clientes";
        </script>';
    }else if($persona->estado ==2){
        echo parent::act_state_persona($_GET['id_persona']) ? '<script type="text/javascript">
        alert("¡Cambiando estado...!");window.location.href="?controller=empleado&method=clientes";
        </script>' : '<script type="text/javascript">
        alert("¡Cambiando estado...!");window.location.href="?controller=empleado&method=clientes";
        </script>';
