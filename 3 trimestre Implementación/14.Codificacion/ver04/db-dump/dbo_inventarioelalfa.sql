...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-11-2021 a las 22:45:46
...
(98, NULL, 1, 12, 2, 20, '2021-10-29 02:39:46'),
(99, NULL, 1, 12, 2, 100, '2021-10-29 03:41:43');
...
(1, 'Camiseta Polo', 20000, 23800, 'azul', 19, 'Disponible', 'seda', NULL, '', 8, 2),
...
--
ALTER TABLE `movimientos`
  MODIFY `id_movimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=100;
...
--
ALTER TABLE `tipomovimiento`
  MODIFY `Idmovi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
