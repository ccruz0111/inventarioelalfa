  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
        ...
        <input type="text" placeholder="names lastnames" required class="form-control col-10" name="ProveNombres">
        </div>
      </div>
      <div class="row">
        ...
        <input type="text" placeholder="0000000000000000" required class="form-control col-10" name="ProveNumDoc">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
