              ...
              <div class="card-body" id="h1">
                <table id="example1" class="table table-bordered table-striped">
                 ...
                 <tr>
                    ...
                    <td><a href="?controller=empleado&method=state_persona&id_persona=<?=$persona->id_persona?>"><i class="material-icons text-dark">refresh</i></a></td>
                  </tr>
                 <?php endforeach; ?>
                  </tfoot>
                </table>
