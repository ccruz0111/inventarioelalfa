  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
        ...
        <a id="boton_agregar" class="btn btn-white ml-2"><i class="text-dark">person_add_alt_1</i></a>
       <a id="limpiar_formulario" class="btn btn-white ml-2"><i class="text-dark">delete</i></a>
       </div>
      </div>
       <div id="mensaje1"></div>
       <div id="mensaje"></div>
