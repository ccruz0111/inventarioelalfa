  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
        ...
        <input type="text" placeholder="product name" required class="form-control col-10" name="Nombproduc">
        </div>
      </div>
      <div class="row">
        ...
        <input id="precio1" type="text" placeholder="$0" required class="form-control col-10" name="PrecCompproduc">
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
      ...
      <div class="row">
        ...
        <select required name="Proveedores_CodiProve" id="" class="form-control col-10">
          <option required disabled selected>Selecciona aquí tu proveedor</option>
      ...
      <div class="row">
        ...
        <select  required name="Categorias_idCate" id="" class="form-control col-10">
