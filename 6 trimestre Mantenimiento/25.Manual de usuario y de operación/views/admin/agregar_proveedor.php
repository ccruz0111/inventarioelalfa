  ...
  <div class="row">
    <div class="col-12">
     ...
     <div class="row">
        ...
        <input type="text" placeholder="names lastnames" class="form-control col-10" name="ProveNombres" required>
        </div>
      </div>
      <div class="row">
        ...
        <input type="text" placeholder="0000000000000000" class="form-control col-10" name="ProveNumDoc" required>
        </div>
      </div>
      <div class="row">
        <div class="col-2 mx-5">
